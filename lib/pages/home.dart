                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            'Learn all of the fundamentals of JavaScript,This tutorial covers all basic features of JavaScript programming',
                            style: TextStyle(
                                fontSize: 10,
                                fontFamily: 'Poiret',
                                color: Colors.white),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            'Learn PHP is finally available! by learning the most widely used web programming language in the world!',
                            style: TextStyle(
                                fontSize: 10,
                                fontFamily: 'Poiret',
                                color: Colors.white),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            'Learn and practice SQL immediately, with SoloLearn’s FREE SQL tutorial! Create, access, and manipulate databases',
                            style: TextStyle(
                                fontSize: 10,
                                fontFamily: 'Poiret',
                                color: Colors.white),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            "Learn Python in the most social and fun way with SoloLearn Learn Python, one of today's most in-demand.",
                            style: TextStyle(
                                fontSize: 10,
                                fontFamily: 'Poiret',
                                color: Colors.white),
